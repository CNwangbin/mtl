...
from mtl.trainer.training import train_loop
from mtl.utils.model import load_model_checkpoint
from mtl.utils.random_utils import random_seed
...
parser.add_argument('--train-data',
                    default='data/pfam/train_data_embedding.pkl',
                    type=str,
...
parser.add_argument('--end-lr',
                    ...
                    metavar='END-LR',
                    help='initial learning rate')
# protein_dim, latent_dim, prediction_dim
...
parser.add_argument('--experiment', default='mtl', type=str)
...
def main(args):
    ...
    train_dataset = SpeciesEmbeddingDataset(args.train_data, species_map)
